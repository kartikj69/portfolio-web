...
class AddBlog extends Component {
    ...
    onSubmit= async (handler, event)=>{
        ...
        const responce = await axios.post("http://127.0.0.1:5000/api/blog",newBlog);
        
        const isSucessfull = responce.data.isSucessfull;
        
        if (isSucessfull){
            this.setState({
                submitMessage:`Blog published sucessfully`,
          ...
          <Consumer>
              {(value)=>
              {
               ...
               return (<div className='container-fluid my-5 py-5 '>
                <h1 className="text-center font-weight-light"> Add <span className="text-warning">Blog</span></h1>
